#!/bin/bash
#SBATCH --job-name=test-traditional
#SBATCH --output=./Log/test_Traditional_output_%j.log
#SBATCH --error=./Log/test_Traditional_error_%j.log
#SBATCH --nodes=1
#SBATCH --ntasks=1
