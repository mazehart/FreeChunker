#!/bin/bash
#SBATCH --job-name=test-freechunker
#SBATCH --output=./Log/test_freechunker_output_%j.log
#SBATCH --error=./Log/test_freechunker_error_%j.log
#SBATCH --nodes=1
#SBATCH --ntasks=1
