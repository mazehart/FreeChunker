...
class QASystem:
    def __init__(self, 
        ...
        print("🚀 Initializing Semantic QA System...")
        ...
        print("✅ Semantic QA System initialized")
...
{{
    ...
    def evaluate_single_run(self, topk_values=[1, 3, 5], verbose=False, save_results=True):
        ...
        if save_results:
            ...
            lines = []
            lines.append(f"# Semantic QA Results ({timestamp})")
            lines.append("")
...
def main():
    ...
    for embed_model in embed_models:
        ...
        for _ in range(repeats):
            semantic_dataset_path = "../Data/LongBench-v2_chunked/Semantic/models--BAAI--bge-m3"
            qa_system = QASystem(
        ...
        log_stats(f"\n{'='*60}")
        log_stats(f"📊 Semantic Evaluation Stats ({repeats} runs mean±std)")
        log_stats(f"{'='*60}")
