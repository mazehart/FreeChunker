...
train_dataset = load_from_disk('./vector/nomic-embed-text-v1.5/train')
# Load validation set data (assuming same structure as training set)
val_dataset_full = load_from_disk('./vector/nomic-embed-text-v1.5/val')
...
save_dir = f'./saved_models/nomic-embed-text-v1.5'
